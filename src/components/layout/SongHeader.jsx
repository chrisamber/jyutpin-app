...
export default function SongHeader() {
  ...
  return (
    <div className="mb-6 print:mb-4">
      {/* Back to search — persistent, touch-friendly (44x44 min) */}
      <button
        onClick={() => dispatch({ type: "SET_VIEW", view: "search" })}
        aria-label="Back to search"
        className="print:hidden -ml-2 mb-2 inline-flex items-center gap-1.5 min-h-[44px] min-w-[44px] px-2 py-2 rounded-lg text-[var(--color-text-secondary)] hover:text-accent hover:bg-[var(--color-bg-elevated)] transition-colors font-mono text-[11px]"
      >
